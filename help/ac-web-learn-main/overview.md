...
> * la [documentation web d’Adobe Campaign](https://experienceleague.adobe.com/docs/campaign-web/v8/campaign-web-home.html) pour plus d’informations sur l’interface utilisateur web de Campaign.
